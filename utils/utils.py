...
def sample_images(epoch, real_A, real_B, generator):
    generator.eval()
    fake_B = generator(real_A)
    idt_B = generator(real_B)
    ...
    idt_B = torchvision.utils.make_grid(idt_B, nrow=4, normalize=True)

    image_grid = torch.cat((real_A, fake_B, real_B, idt_B), 1)

    torchvision.utils.save_image(image_grid, "output/A/%03d.png" % (epoch), normalize=False)
